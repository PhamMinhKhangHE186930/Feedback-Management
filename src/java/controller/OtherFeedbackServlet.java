 ...
 * @author ADMIN
 */
public class OtherFeedbackServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet OtherFeedbackServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet OtherFeedbackServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        int numberperpage = 3;
        flist = feedbackDAO.searchFeedbacks(page, numberperpage, account.getId(), null, fromDate, toDate, typeid, "1", search, sortdate, "other");
        countSearch = feedbackDAO.countAfterSearch(account.getId(), null, fromDate, toDate, typeid, "1", search, "other");
        ...
        request.getRequestDispatcher("./student/otherfeedback.jsp").forward(request, response);
...
//                list = feedbackDAO.searchFeedbacks(account.getId(), status, fromDate, toDate, type, checkPublic, search, true);
//            } else {
//                list = feedbackDAO.searchFeedbacks(account.getId(), null, fromDate, toDate, type, checkPublic, search, true);
//            }
//
